...
[![Build Status](https://travis-ci.org/andreamelloncelli/ansible-rstudio-server.svg?branch=master)](https://travis-ci.org/andreamelloncelli/ansible-rstudio-server)
